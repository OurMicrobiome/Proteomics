...
```{r}
ggplot(df[which(df$group1 == "M_C"),], aes(x=Metabolite, y=meancountdifference, color = p)) + geom_point() + coord_flip() + theme(axis.text.y = element_blank())
```

ggplot for all metabolites in the Organic layer
```{r}
